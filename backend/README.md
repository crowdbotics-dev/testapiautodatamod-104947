...
## Project Structure
    ...
    ├── testapiautodatamod_104947  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_104947`
...
2. Clone this repo and `cd testapiautodatamod_104947`
